...
import edgeiq
"""
Application use the Jetson CSI IMX477 interface using the JetsonVideoStream APIs.
...
def main():
    ...
    try:
        with edgeiq.JetsonVideoStream(cam=0,
                                      ...
                                      camera_mode=edgeiq.
                                      JetsonCameraMode.
                                      IMX477_1920x1080_60_1) as video_stream, \
            ...
            while True:
                ...
                frame = edgeiq.resize(frame, width=300)
